...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        config.setActiveRecord(true) // 是否支持AR模式
                ...
                .setServiceName("%sService") // 设置生成的service接口的名字的首字母是否为I(默认Service类前面有一个I)
                .setBaseResultMap(true)// 基本ResultMap
                .setBaseColumnList(true);// 基本的列
...
//                .setInclude("book_info"); // 生成的表
        ...
        pkConfig.setParent("com.jacky.mybatis_plus_demo")// 设置父包
                .setMapper("dao")// dao层
                .setService("service")// Service 层
                .setController("controller")// Controller 层
                .setEntity("entity")// 实体类
                .setXml("mapper");// 接口映射的xml文件
